...
public class ConcurrentCommandBuilder {
	...
	public static LinkedList<ConcurrentFilter> createFiltersFromCommand(String command){
	...
	private static boolean linkFilters(LinkedList<ConcurrentFilter> filters, String command){
